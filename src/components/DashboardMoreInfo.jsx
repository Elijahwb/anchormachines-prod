...
function MoreInfo(props) {
    return (
        <div className='dashboard-more-info-container my-5 py-5 gap-4 grid grid-cols-4 sm:grid-cols-3  md:grid-cols-4'>
            ...
            <div className='more-info-item border-r-2 border-yellow-300 text-black shadow-lg pb-1' style={{'borderRight': '3px solid green'}}>
            ...
            <div className='more-info-item border-r-2 border-yellow-300 text-black shadow-lg' style={{'borderRight': '3px solid #ffcc17'}}>
            ...
            <div className='more-info-item border-r-2 border-yellow-300 text-black shadow-lg' style={{'borderRight': '3px solid #03a9f4'}}>
            ...
            <div className='more-info-item border-r-2 border-yellow-300 text-black shadow-lg' style={{'borderRight': '3px solid crimson'}}>
